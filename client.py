...
my_username = input("Enter the username: ")
...
while True:
    ...
    if message:
        ...
        print(f'> {current_time} ' + f'{my_username}: {message.decode("utf-8")} \n')
    try:
